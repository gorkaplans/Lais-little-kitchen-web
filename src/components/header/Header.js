...
const Header = () => {
    ...
    <section className="section section-header">
            ...
            <a className={(activo) ? "desaparecer" : "social-icon"} target="_blank" href="https://www.instagram.com/laislittlekitchen/?hl=es">
